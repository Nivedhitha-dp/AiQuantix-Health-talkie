 ...
 */
include('https://code.responsivevoice.org/responsivevoice.js');
 var y='';
 var count=0;
...
function setUserResponse(message) {
    const user_response = `<img class="userAvatar" src='./static/img/userprofile.jpeg'><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function getBotResponse(text) {
    botResponse = `<img class="botAvatar" src="https://cdn3d.iconscout.com/3d/premium/thumb/doctor-6368720-5250867.png?f=webp"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
    return botResponse;
}
...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            if(count%2==0){
            responsiveVoice.speak(fallbackMsg, "Hindi Female");
            }

            const BotResponse = `<img class="botAvatar" src="https://cdn3d.iconscout.com/3d/premium/thumb/doctor-6368720-5250867.png?f=webp"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
                ...
                if (Object.hasOwnProperty.call(response[i], "text")) {
                    if (response[i].text != null) {
                        ...
                        if (html.includes("<ul") || html.includes("<ol") || html.includes("<li") || html.includes('<h3')) {
                            ...
                            if (!botResponse) {
                                botResponse = `<img class="botAvatar" src="https://cdn3d.iconscout.com/3d/premium/thumb/doctor-6368720-5250867.png?f=webp"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
                            }
                        }
                     ...
                     if(count%2==0)
                        {
                        responsiveVoice.speak(y,"Hindi Female");
                        }
